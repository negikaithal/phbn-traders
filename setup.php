...
try {
    ...
    if ($stmt->fetchColumn() == 0) {
        $categories = [
            ['Ground Spices', 'ground-spices', 'Finely ground, aromatic single-spice powders processed at low temperatures to preserve natural essential oils.', 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=600&auto=format&fit=crop&q=80'],
            ['Whole Spices', 'whole-spices', 'Hand-picked whole spices direct from traditional spice estates with rich natural aroma and authentic oils.', 'https://images.unsplash.com/photo-1509358217973-8898c6913c95?w=600&auto=format&fit=crop&q=80'],
            ['Blended Masalas', 'blended-masalas', 'Masterfully crafted spice blends combining age-old heritage recipes for curry, biryani, and roasted delights.', 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=600&auto=format&fit=crop&q=80'],
            ['Exotic & Premium', 'exotic-premium', 'Rare, luxury spice varieties including Grade-1 Kashmiri Saffron, Ceylon Cinnamon, and Green Cardamom.', 'https://images.unsplash.com/photo-1599940824399-b87987ceb72a?w=600&auto=format&fit=crop&q=80'],
            ['Organic & Wellness', 'organic-wellness', 'Certified organic spices rich in antioxidants, immunity-boosting bioactives, and herbal wellness properties.', 'https://images.unsplash.com/photo-1608686207856-001b95cf60ca?w=600&auto=format&fit=crop&q=80']
        ];
    ...
    if ($stmt->fetchColumn() == 0) {
        $products = [
            ...
            [
                ...
                'Medium-Hot',
                'https://images.unsplash.com/photo-1509358217973-8898c6913c95?w=600&auto=format&fit=crop&q=80',
                90,
                1
            ],
            [
            ...
            [
                ...
                1250.00,
                '1g, 2g, 5g, 10g',
                '100% pure authentic all-red crocus filaments from Pampore, Kashmir. Rich in crocin and safranal giving deep amber tint and regal aroma.',
            ...
            [
                ...
                210.00,
                '100g, 250g, 500g',
                '100% certified organic dry ginger powder ground from pesticide-free ginger rhizomes. Zesty, sharp warming punch.',
                'Assam / Wayanad',
